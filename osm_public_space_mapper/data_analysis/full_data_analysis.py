...
from osm_public_space_mapper.utils import helpers
...
traffic_areas = analyse_traffic_area.get_traffic_areas_as_polygons(dataset, inaccessible_enclosed_areas_cleaned, buildings, 
                                                            local_var.highway_default_widths, local_var.cycleway_default_widths, 
                                                            local_var.tram_gauge, local_var.tram_buffer, local_var.train_gauge, local_var.train_buffer)
